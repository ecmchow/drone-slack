...
[![Build Status](https://img.shields.io/github/actions/workflow/status/ecmchow/drone-slack/build.yml?branch=custom&style=flat-square&logo=GitHub)](https://github.com/ecmchow/drone-slack/actions/)
...
> ### This is a customized version of the [Official Slack plugin](https://github.com/drone-plugins/drone-slack) for Drone CI. See [Docker Hub](https://hub.docker.com/repository/docker/ecmchow/drone-slack/general) for more details.
